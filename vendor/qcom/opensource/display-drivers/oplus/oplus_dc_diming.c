...
void oplus_ofp_hande_display_backlight(struct dsi_display *display, int hbm_status)
{
	...
	case 0 :
		if ((!strcmp(display->panel->oplus_priv.vendor_name, "S6E3HC3")) ||
		    (!strcmp(display->panel->oplus_priv.vendor_name, "AMS662ZS02")) ||
		    (!strcmp(display->panel->oplus_priv.vendor_name, "S6E3HC4")) ||
		    (!strcmp(display->panel->oplus_priv.vendor_name, "BF088_AB319")) ||
		    (!strcmp(display->panel->oplus_priv.vendor_name, "BF092_AB241"))) {
