...
#if defined(CONFIG_PXLW_IRIS)
static int dsi_display_parse_boot_display_selection_iris(struct platform_device *pdev, int panel_source)
{
...
#if defined(CONFIG_PXLW_IRIS)
	if(index == DSI_PRIMARY && (!strcmp(boot_displays[0].name, "qcom,mdss_dsi_oplus21606_nt37701b_1080_2412_dsc_cmd_udc")))
		dsi_display_parse_boot_display_selection_iris(pdev, 1);
	else if (index == DSI_PRIMARY &&  (!strcmp(boot_displays[0].name, "qcom,mdss_dsi_oplus21605_nt37701a_1080_2412_dsc_cmd")))
		dsi_display_parse_boot_display_selection_iris(pdev, 2);
#endif
