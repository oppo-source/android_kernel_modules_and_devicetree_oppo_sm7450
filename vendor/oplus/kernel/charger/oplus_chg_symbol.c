...
#include "oplus_chg.h"
#if defined(CONFIG_OPLUS_SM8350_CHARGER) || defined(CONFIG_OPLUS_SM8450_CHARGER)
...
#endif /* defined(CONFIG_OPLUS_SM8350_CHARGER) || defined(CONFIG_OPLUS_SM8450_CHARGER) */
